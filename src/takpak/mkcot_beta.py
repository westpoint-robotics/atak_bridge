# Make CoT mkcot.py
#
# Oct. 2021 - Add image CoT
__developer__ = 'Jinho Kim <jinho.kim@westpoint.edu>'
#
...
######################## tgt_call = False / cot_point = False / cot_callsign = ranger1
######################## precisionlocation
        if not tgt_call:
            precision_attr = {
                "altsrc": "GPS",
...
#                "iconsetpath": iconpath
        ...
        if img_call:
            ...
            et.SubElement(detail,'image', attrib=image_attr).text = img_call # Insert Base64 encorded image into cot_xml
